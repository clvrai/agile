...
from policy_based.rlf.baselines.monitor import Monitor
from policy_based.rlf.baselines.common.atari_wrappers import make_atari, wrap_deepmind
from policy_based.rlf.baselines.vec_env import VecEnvWrapper
from policy_based.rlf.baselines.vec_env.dummy_vec_env import DummyVecEnv
from policy_based.rlf.baselines.vec_env.shmem_vec_env import ShmemVecEnv
from policy_based.rlf.baselines.vec_env.vec_normalize import \
    VecNormalize as VecNormalize_

# Include our custom environments
import policy_based.envs.gym_minigrid
...
def make_env(env_id, seed, rank, log_dir, allow_early_resets, trans_fn,
    ...
    def _thunk():
        ...
        elif env_id.startswith('RecSim'):
            dict_embedding = launch_embedding(args=args, no_cuda=True)
        ...
        if not env_id.startswith('RecSim'):
...
class VecPyTorch(VecEnvWrapper):
    ...
    def get_test_aval(self):
        return self.venv.get_test_aval()
...
class VecPyTorchFrameStack(VecEnvWrapper):
    ...
    def step_wait(self):
        ...
        self.stacked_obs[:, :-self.shape_dim0] = \
            self.stacked_obs.clone()[:, self.shape_dim0:]
