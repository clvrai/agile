...
register(
    ...
    entry_point='envs.gym_minigrid.envs:MemoryS17Random',
)
...
register(
    ...
    entry_point='envs.gym_minigrid.envs:MemoryS13Random',
)
...
register(
    ...
    entry_point='envs.gym_minigrid.envs:MemoryS13',
)
...
register(
    ...
    entry_point='envs.gym_minigrid.envs:MemoryS11',
)
...
register(
    ...
    entry_point='envs.gym_minigrid.envs:MemoryS9',
)
...
register(
    ...
    entry_point='envs.gym_minigrid.envs:MemoryS7',
)
