...
# __version__ = '2.0.8'
#
# TARGET_DIR = os.path.join(os.path.dirname(__file__), "torch_scatter_binary")
#
# for library in ['_version', '_scatter']:
#     cuda_spec = importlib.machinery.PathFinder().find_spec(f'{library}_cuda', [TARGET_DIR])
#     cpu_spec = importlib.machinery.PathFinder().find_spec(f'{library}_cpu', [TARGET_DIR])
...
#     else:
#         from value_based.gnn.torch_geometric_utils.torch_scatter_placeholder import cuda_version_placeholder
#
#         torch.ops.torch_scatter.cuda_version = cuda_version_placeholder
#
#         from value_based.gnn.torch_geometric_utils.torch_scatter_placeholder import scatter_placeholder
#
#         torch.ops.torch_scatter.scatter_mul = scatter_placeholder
#
#         from value_based.gnn.torch_geometric_utils.torch_scatter_placeholder import scatter_arg_placeholder
#
#         torch.ops.torch_scatter.scatter_min = scatter_arg_placeholder
#         torch.ops.torch_scatter.scatter_max = scatter_arg_placeholder
#
#         from value_based.gnn.torch_geometric_utils.torch_scatter_placeholder import segment_csr_placeholder
#         from value_based.gnn.torch_geometric_utils.torch_scatter_placeholder import segment_csr_arg_placeholder
#         from value_based.gnn.torch_geometric_utils.torch_scatter_placeholder import gather_csr_placeholder
#
...
#
#         from value_based.gnn.torch_geometric_utils.torch_scatter_placeholder import segment_coo_placeholder
#         from value_based.gnn.torch_geometric_utils.torch_scatter_placeholder import segment_coo_arg_placeholder
#         from value_based.gnn.torch_geometric_utils.torch_scatter_placeholder import gather_coo_placeholder
#
